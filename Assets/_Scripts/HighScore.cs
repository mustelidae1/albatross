...
{
    static public HighScore S; // singleton 
    ...
    private int highScoreThreshhold = int.MaxValue; 
    ...
    void Start()
    {
        ...
        Debug.Log("Threshhold: " + highScoreThreshhold); 
    }
    ...
    protected virtual void InitializeFirebase()
    {
        ...
        app.SetEditorDatabaseUrl("https://albatross-game.firebaseio.com/");
                      ...
                      else
                      {
                        ...
                        + "  " + childSnapshot.Child("email").Value.ToString());
                          ...
                          foreach (string item in leaderBoard)
                          {
                              ...
                              int result;
                              int.TryParse(strArr[0].Trim(), out result);

                              // if ((result != 0) && result < highScoreThreshhold)  <----(result != 0) can't have parenthesis
                              if (result != 0 && result < highScoreThreshhold)
                              {
                                  highScoreThreshhold = result;
                                  Debug.Log("Setting thresh: " + result);
                              }
   ...
   public bool isHighScore(int num)
    {
        return num > highScoreThreshhold; 
    }
